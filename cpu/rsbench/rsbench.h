...
void run_event_based_simulation(Input input, SimulationData data,
                                SimulationData SD, unsigned long *vhash_result);
void run_event_based_simulation_optimization_1(Input in, SimulationData GSD,
                                               unsigned long *vhash_result);
void xs_lookup_kernel_baseline(Input in, SimulationData GSD);
void calculate_macro_xs(double *macro_xs, int mat, double E, Input input,
                        ...
                        Window *windows, Pole *poles, int max_num_windows,
                        int max_num_poles);
...
// __device__ void calculate_sig_T( int nuc, double E, Input input, double *
// pseudo_K0RS, RSComplex * sigTfactors );
RSComplex fast_nuclear_W(RSComplex Z);
// void d_fast_nuclear_W(RSComplex Z, RSComplex *dZ);
